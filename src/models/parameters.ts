...
export type ParameterValueSourceV3 =
  ...
  | { kind: 'dataset'; datasetId: string; valueField: string; labelField: string; dependencies?: ParameterOptionDependencyV3[] }

export interface ParameterOptionDependencyV3 {
  parameterId: string
