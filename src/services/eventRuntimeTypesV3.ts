import type { DashboardApplicationV3, EventNameV3, JsonObjectV3, JsonValueV3, RefreshActionV3 } from '../models/dashboard-v3.ts'
...
export type ResolvedEventActionRequestV3 = ResolvedSetParameterRequestV3 | ResolvedRefreshRequestV3
...
export type EventActionRequestV3 = SetParameterActionRequestV3 | RefreshActionRequestV3
export interface ParameterCommitHandoffV3 { kind: 'parameterCommit'; applicationId: string; actionId: string; eventTransactionId: string; parameterTransactionId: string; changedParameterIds: string[]; values: Record<string, JsonValueV3> }
...
export type EventActionPortV3 = SetParameterActionPortV3 | RefreshActionPortV3
export interface EventActionPortsV3 { setParameter: SetParameterActionPortV3; refresh: RefreshActionPortV3 }
...
export interface LateActionAuditV3 { transactionId: string; actionId: string; portType: 'setParameter' | 'refresh'; actualStatus: 'succeeded' | 'failed' | 'skipped' | 'rejected'; code?: string; message?: string; evidence?: JsonValueV3; evidenceStatus: 'absent' | 'accepted' | 'invalid'; evidenceError?: string; readError?: string; cancellationRequested: boolean; unknownSideEffect: boolean; completedAt: number }
